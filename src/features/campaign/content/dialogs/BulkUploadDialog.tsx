...
import { useBulkVideoUpload } from "../hooks/useBulkVideoUpload";
...
export function BulkUploadDialog({
  ...
  const maxSlots = unassignedRecordIds.length;
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          <DialogTitle>Upload Videos to Ready to Publish</DialogTitle>
          <DialogDescription>
            Upload up to {maxSlots} video{maxSlots !== 1 ? "s" : ""} directly to the Ready to Publish section.
            Videos will be randomly assigned to available content slots.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          {isCreating && (
            <div className="flex items-center justify-center gap-2 py-2 text-sm text-muted-foreground">
              ...
              <span>Assigning videos to content slots...</span>
            </div>
          )}
