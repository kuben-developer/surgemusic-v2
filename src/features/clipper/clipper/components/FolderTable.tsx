...
export function FolderTable({ folders, onSelectFolder, onDeleteFolder }: FolderTableProps) {
  if (folders.length === 0) {
    return (
      <div className="text-center py-16 text-muted-foreground border rounded-lg">
        ...
        <p className="text-sm">Create your first folder to get started organizing your videos.</p>
      </div>
    );
  }
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center">Videos Processing</TableHead>
